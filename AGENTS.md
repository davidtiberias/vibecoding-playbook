...
- **2026-02-04:** Added `Article015.md` - "The Human-in-the-Loop: Why Oversight is the Heart of Verification-Driven Development".
- **2026-02-04:** Created `scripts/agent-verify.sh` to provide an automated verification pipeline for maintenance tasks.
