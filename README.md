...
- **Enforcing Strict Rules (Invariants):** Creating rules that govern the process to ensure stability and predictable outcomes.

This website is the visualization "playbook" for that workflow.

## What You'll Find on the Site

When you visit the website, you can explore three main areas:

1.  **The Workflow Map:** An interactive, step-by-step guide through the entire development process.
2.  **System Invariants:** A simple explanation of the core rules that make the workflow reliable.
3.  **Tool Analysis:** A reference table comparing the strengths and weaknesses of each AI tool used.

This GitHub repository simply holds the source code. **The real experience is on the website itself.**
